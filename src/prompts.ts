...
${BIG_PORTFOLIO_NOTE}`,
  ...
  bondPicker: (amount: string, horizon: string) => `Подбери облигации под сумму и горизонт.
...
export function registerPrompts(server: McpServer): void {
  ...
  server.registerPrompt(
    "bond_picker",
    {
      ...
      argsSchema: {
        amount: z.string().describe("Сумма в рублях БЕЗ пробелов, например 500000"),
        horizon: z.string().describe("Горизонт в годах числом (например 4) или дата «до 2029» — слитно, без пробелов"),
      },
    },
